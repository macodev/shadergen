...
<html>
		...
		<body>
				<div id="genform">
						...
						<h2>Crea e scarica un PNG con trasparenza da usare nei background.</h2>
						<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
								<p><label>Larghezza </label><input type="text" name="width" value="10"/> <span>px</span></p>
								<p><label>Altezza </label><input type="text" name="height" value="10"/> <span>px</span></p>
								<p><label>Colore </label><input type="text" name="color" value="fff"/><span>(esadecimale)</span></p>
								<p><label>Trasparenza </label><input type="text" name="alpha" value="40"/><span>(0-100)</span></p>
								<p><input type="submit" name="submit" value="crea"/></p>
						</form>
